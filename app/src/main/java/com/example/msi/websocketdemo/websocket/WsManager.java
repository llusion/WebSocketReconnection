...
public class WsManager {
    ...
    private static final String DEF_TEST_URL = "ws://10.7.5.88:8089/gs-robot/notice/device_status";//测试服默认地址
    private static final String DEF_RELEASE_URL = "ws://10.7.5.88:8089/gs-robot/notice/device_status";//正式服默认地址
